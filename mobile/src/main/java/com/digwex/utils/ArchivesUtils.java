...
public class ArchivesUtils {
    ...
    public static boolean unZip(String extractFolder, String zipFile)
    {
        try
        {
            int BUFFER = 2048;
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                zip = new ZipFile(file, Charset.forName("Cp437"));
            }else{
            ...
            while (zipFileEntries.hasMoreElements())
            {
                ...
                if (!entry.isDirectory())
                {
                    ...
                    //println(DEBUG, ArchivesUtils.class, "ZIP: " + destFile);
